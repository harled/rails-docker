...
function help () {
  ...
  echo "1. install latest packages for rails-dev 3.4.2 image"
  echo "   > freshen rails-dev 3.4.2"
  echo "2. after testing, promote latest image to new 3.4.2 tag"
  echo "   > release rails-dev 3.4.2"
  echo
  echo "example (full send, skips testing): "
  echo "1. build, tag and deploy an updated image rails-dev 3.4.2 image"
  echo "   > update rails-dev 3.4.2"
  echo
}
